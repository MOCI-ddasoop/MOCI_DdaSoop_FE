...
import CardImage from "@/domain/mypage/components/CardImage";
import FeedModal from "@/domain/mypage/components/FeedModal";
import tw from "@/shared/utils/tw";
import { throttle } from "@/shared/utils/throttle";

import { useInfiniteQuery } from "@tanstack/react-query";
import { fetchMockFeeds, MOCK_FEED } from "./mockFeeds";
...
function MainCardContainer({ className }: { className?: string }) {
